...
// Sundial animation ***********************************************************
		...
		{	
			...
			var interval = end.getHours() - begin.getHours();
			var dayPercent = (current.getHours() - begin.getHours()) * (100/interval);
			//console.log(current.getHours()-begin.getHours());
